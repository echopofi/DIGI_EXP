...
const items = portfolioItems.filter((item) => item.category === "Corporate");
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="From boardroom presentations to stadium-sized conferences — we produce corporate events that command attention."
      />
