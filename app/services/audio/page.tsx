...
export default function AudioPage() {
  const service = services.find((s) => s.id === "audio")!;
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-8">
                Crystal-Clear Sound for Every Seat
              </h2>
      ...
      <CTABanner headline="Need Sound for Your Event?" buttonText="Contact Us" buttonHref="/contact" />
    </>
  );
}
